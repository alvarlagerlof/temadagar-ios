...
class PopularViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        parseJSON("https://api.temadagar.ravla.org/v5/data/data_popular.json")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCellWithIdentifier("popularCell", forIndexPath: indexPath) as! PopularViewCell
